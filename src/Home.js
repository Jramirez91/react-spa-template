    ...
    this.state = {
      ...
      items: [
        <div className="item" key={1}>
          <img src={img1} alt="Img1" className="owl-image" />
        </div>,
        <div className="item" key={2}>
          <img src={img2} alt="Img2" className="owl-image" />
        </div>,
        <div className="item" key={3}>
          <img src={img3} alt="Img3" className="owl-image" />
        </div>,
        <div className="item" key={4}>
          <img src={img4} alt="Img4" className="owl-image" />
        </div>
      ]
    };
  }
